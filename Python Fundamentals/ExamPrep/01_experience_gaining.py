...
if is_enough:
    print(
        f"Player successfully collected his needed experience for {battles_count} battles."
    )
else:
    needed_experience = experience_needed - total_experience
    print(
        f"Player was not able to collect the needed experience, {needed_experience:.2f} more needed."
    )
