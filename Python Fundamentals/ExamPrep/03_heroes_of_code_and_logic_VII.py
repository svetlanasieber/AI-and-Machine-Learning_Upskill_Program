    ...
    if real_command == "CastSpell":
        ...
        if hero_n in all_heroes:
            if mp_needed <= all_heroes[hero_n]["MP"]:
                ...
                print(
                    f"{hero_n} has successfully cast {spell_name} and now has {all_heroes[hero_n]['MP']} MP!"
                )
            else:
        ...
        if hero_n in all_heroes:
            ...
            if all_heroes[hero_n]["HP"] > 0:
                print(
                    f"{hero_n} was hit for {damage} HP by {attacker} and now has {all_heroes[hero_n]['HP']} HP left!"
                )
            else:
